...
- Flash regressions should stay under `+2 KB` per batch unless a new primitive or platform feature is intentionally added.

## Cross-target snapshots

- ESP8266 `UniversalSmokeTest` (`POWER_SAVE`): flash `241188 / 1048576`, RAM `28864 / 80192`, `data=1496`, `rodata=976`, `bss=26392`
- ESP32 `ESP32SensorHub` (`DEFAULT`): flash `285904 / 1310720`, RAM `24676 / 327680`
- RP2040 `RP2040LoopMonitor` (`DEFAULT`): flash `57620 / 2093056`, RAM `11440 / 262144`
- STM32 `STM32ControlLoop` (`DEFAULT`): flash `14892 / 524288`, RAM `3732 / 131072`

## Wemos comparison

- Blocking baseline: flash `237092 / 1048576`, RAM `28300 / 80192`
- ZeroKernel comparison sketch: flash `240436 / 1048576`, RAM `29044 / 80192`
...
- The most expensive KPI for ZeroKernel is deterministic timing. A small RAM or flash increase is acceptable if `fast_miss` stays `0`.
